...
if __name__ == '__main__':
    ...
    # Static orbit image
    static_orbit_plot(orbit, frame=1500, savefile="testimage", color="orangered")
    # Movie with rotation and zooming out
    make_orbit_movie(orbit, startframe=4400, endframe=5400, skipevery=2, color="orangered", output_label="testmovie",
